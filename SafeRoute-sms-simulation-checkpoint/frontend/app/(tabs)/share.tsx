      ...
      prev.map((contact) =>
        contact.id === contactId
          ? {
              ...
              lastUpdate: contact.isSharing ? undefined : "Just now",
            }
          : contact,
      ),
    );
        ...
        {isLiveSharing ? (
          <View style={styles.activeBanner}>
            ...
            <Text style={styles.activeText}>
              Sharing location with {activeShares} contact
              {activeShares !== 1 ? "s" : ""}
            </Text>
          </View>
        ) : null}
          ...
          <View key={contact.id} style={styles.contactCard}>
            <View style={styles.rowBetween}>
              ...
              <Pressable
                style={[
                  styles.shareButton,
                  contact.isSharing && styles.shareButtonDanger,
                ]}
                onPress={() => toggleContactSharing(contact.id)}
                disabled={!isLiveSharing}
              >
                <MaterialIcons
                  name={contact.isSharing ? "close" : "share"}
                  size={14}
                  color="#FFFFFF"
                />
                <Text style={styles.shareButtonText}>
                  {contact.isSharing ? "Stop" : "Share"}
                </Text>
              </Pressable>
            </View>
          </View>
